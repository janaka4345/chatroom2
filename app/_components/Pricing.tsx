            ...
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                ...
                <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
                    ...
                    <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow  xl:p-8  ">
                        ...
                        <a href="/auth/login" className="text-primary-foreground bg-primary hover:bg-primary/35/30 focus:ring-4 focus:ring-primary font-medium rounded-lg text-sm px-5 py-2.5 text-center ">Get started</a>
                    </div>
                    {/* Pricing Card */}
                    <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow  xl:p-8  ">
                        ...
                        <a href="/auth/login" className="text-primary-foreground bg-primary hover:bg-primary/35/ focus:ring-4 focus:ring-primary font-medium rounded-lg text-sm px-5 py-2.5 text-center   :ring-primary">Get started</a>
                    </div>
                    {/* Pricing Card */}
                    <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow  xl:p-8  ">
                        ...
                        <a href="/auth/login" className="text-white bg-primary hover:bg-primary/35 focus:ring-4 focus:ring-primary font-medium rounded-lg text-sm px-5 py-2.5 text-center   :ring-primary">Get started</a>
                    </div>
                </div>
            </div>
        </section>

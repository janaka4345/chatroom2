...
const BentoMessage = () => {
    return (
        <div className="relative mx-auto flex h-[calc(100dvh/5-10px)] md:h-48  w-full items-center justify-center  overflow-hidden rounded-2xl">
            ...
            <div
                ...
                className="z-10 mx-[4px] flex h-[calc(100dvh/5-10px)] md:h-48 w-full  flex-col gap-0 md:gap-2 rounded-lg"
            >
                <h1 className="ml-4 mt-2 md:mt-4 text-lg md:text-xl text-primary-foreground lg:text-2xl ">
                ...
                />
                <h1 className="ml-4 text-lg md:text-xl text-primary-foreground  lg:text-2xl">

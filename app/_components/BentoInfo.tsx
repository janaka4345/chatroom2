'use client'
import { LazyMotion, domAnimation, useAnimate, usePresence } from "framer-motion";
        ...
        <>
            <LazyMotion features={domAnimation} >
                <div ref={box1Ref}
                    ...
                    className="mx-auto absolute inset-0  flex h-full w-full flex-col items-center justify-center  rounded-3xl bg-green-500 text-xl "
                >

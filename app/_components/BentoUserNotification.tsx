...
const BentoUserNotification = () => {
    return (
        <div className="flex rounded-xl  border border-gray-200  bg-gradient-to-l from-accent to-gray-200 p-1 text-gray-500 shadow md:min-h-full lg:p-2">
            <AvatarIcon
            ...
            <div className="ms-3 text-xs font-normal">
                ...
                <div className="line-clamp-2 text-xs font-normal lg:line-clamp-none md:text-sm">

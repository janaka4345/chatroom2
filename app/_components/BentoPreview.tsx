...
const BentoPreview = () => {
    return (
        <>
            <div className="mt-4 m-2  flex items-start gap-2 ">
            ...
            <LazyMotion features={domAnimation}>
                <m.div initial={{ x: '100%' }} animate={{ x: 0, transition: { duration: 0.5, repeat: Infinity, repeatDelay: 2, repeatType: 'loop' } }} className=" absolute w-[350px] h-fit  p-2 bottom-2 right-2 border border-gray-200  text-gray-500 bg-gradient-to-l from-accent to-gray-200 rounded-xl shadow flex" >

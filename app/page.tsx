...
export default async function Home() {
    ...
    return (
        <section className="grid h-[100dvh] md:h-[85dvh] w-[100dvw]  grid-cols-4 md:grid-rows-6 grid-rows-5 gap-2 md:gap-4  px-4  lg:px-20 pb-2">
            ...
            <div
                ...
                className=" relative col-start-2 col-end-5 row-start-5 row-end-6 md:col-start-3 md:col-end-5 md:row-start-4 md:row-end-7 overflow-hidden rounded-3xl border border-gray-100   "
            >
                <BentoPreview />
                {/* 6 */}
            </div>

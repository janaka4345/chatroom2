...
const buttonVariants = cva(
    'inline-flex items-center justify-center whitespace-nowrap rounded-2xl text-sm font-medium transition-colors focus-visible:outline-none  focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50',
    {
        variants: {
            variant: {
                default:
                    'bg-primary text-primary-foreground shadow-lg  shadow-gray-500 hover:bg-primary/90 ',
                destructive:
                ...
                link: 'text-primary shadow-lg underline-offset-4 hover:underline bg-transparent',
                tertiary:
                    'bg-white border-2 border-primary text-primary shadow-lg  shadow-gray-500  ',
            },
            size: {

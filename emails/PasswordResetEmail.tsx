...
export default function PasswordResetEmail({ verificationCode }: { verificationCode: string }) {
    return (
        <Html>
            <Head />
            <Body style={main}>
                <Container style={container}>
                    <Section style={coverSection}>
                        <Section style={imageSection}>
                            <Img
                                src='https://res.cloudinary.com/dqjfskfxu/image/upload/v1721617936/Logo_fvedle.png'
                                width="75"
                                height="45"
                                alt="Chatter's Logo"
                            />
                        ...
                        <Section style={upperSection}>
                            ...
                            <Text style={mainText}>
                                ...
                                verification code when prompted to reset your password. If you don&apos;t want to
